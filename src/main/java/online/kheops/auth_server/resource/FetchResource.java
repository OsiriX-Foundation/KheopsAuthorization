        ...
        try {
            ...
            if(true){//study.isPopulated()) {
                ...
                for (Webhook webhook : webhookList) {
                    ...
                    final NewSeriesWebhook.Builder newSeriesWebhookBuilder = new NewSeriesWebhook.Builder();
                    if (albumId != null && webhook.getAlbum().getId().compareTo(albumId) == 0) {
                        ...
                        newSeriesWebhookBuilder.setSource(targetAlbumUser)
                        ...
                        newSeriesWebhookBuilder.setSource(new Source(callingUser))
                                .setKheopsInstance(context.getInitParameter(HOST_ROOT_PARAMETER))
                                .isUpload()
                                .isAutomatedTrigger();
